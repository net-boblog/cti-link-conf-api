 ...
 */
@Service
public class SystemSettingServiceImp extends AbstractService<SystemSetting> implements SystemSettingService {
    ...
    @Override
    protected List<SystemSetting> select(Integer enterpriseId) {
        return null;
    }
    ...
    private void setRefreshCacheMethod(String methodName,SystemSetting systemSetting){
        try {
            ...
            logger.error("SystemSettingServiceImp.setRefreshCacheMethod error refresh cache fail class = " + this.getClass().getName(),e);
        }
    }
}
