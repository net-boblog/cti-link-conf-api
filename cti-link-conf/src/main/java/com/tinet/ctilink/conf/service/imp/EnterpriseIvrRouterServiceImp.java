...
import com.tinet.ctilink.conf.service.v1.EnterpriseIvrRouterService;
 ...
 */
@Service
public class EnterpriseIvrRouterServiceImp extends AbstractService<EnterpriseIvrRouter> implements EnterpriseIvrRouterService {
    ...
    @Override
    protected List<EnterpriseIvrRouter> select(Integer enterpriseId) {
        return null;
    }
