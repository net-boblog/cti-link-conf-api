...
import com.tinet.ctilink.model.TelSet;
import com.tinet.ctilink.request.TelSetListRequest;
 ...
 */
@Service
public class TelsetServiceImp extends BaseService<TelSet> implements TelsetService,InitializingBean {
    ...
    @Override
    public ApiResult getListTelSets(TelSetListRequest telSetListRequest) {
