...
import com.tinet.ctilink.conf.service.v1.EnterpriseHangupActionService;
 ...
 */
@Service
public class EnterpriseHangupActionServiceImp extends AbstractService<EnterpriseHangupAction> implements EnterpriseHangupActionService {
    ...
    @Override
    protected List<EnterpriseHangupAction> select(Integer enterpriseId) {
        return null;
    }
